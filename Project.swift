...
func createAppTarget(suffix: String = "", isDev: Bool = false, scripts: [TargetScript] = [], dependencies: [TargetDependency] = []) -> Target {
  .target(
    ...
    product: .app,
    bundleId: "de.johannesfroelich.Whisperboard",
  ...
  [createAppTarget()]
    ...
    + [
      ...
      .target(
        ...
        bundleId: "de.johannesfroelich.Whisperboard.ShareExtension",
      ...
      .target(
        ...
        bundleId: "de.johannesfroelich.WhisperboardKit",
        deploymentTargets: appDeploymentTargets,
        infoPlist: .extendingDefault(with: [:]),
      ...
      .target(
        ...
        destinations: appDestinations,
        product: .unitTests,
        bundleId: "de.johannesfroelich.WhisperboardKitTests",
        infoPlist: .default,
      ...
      .target(
        ...
        destinations: appDestinations,
        product: .staticFramework,
        bundleId: "de.johannesfroelich.WhisperboardKit.AudioProcessing",
        infoPlist: .default,
      ...
      .target(
        ...
        destinations: appDestinations,
        product: .unitTests,
        bundleId: "de.johannesfroelich.WhisperboardKit.AudioProcessingTests",
        infoPlist: .default,
      ...
      .target(
        ...
        destinations: appDestinations,
        product: .staticFramework,
        bundleId: "de.johannesfroelich.WhisperboardKit.Common",
        infoPlist: .default,
      ...
      .target(
        ...
        destinations: appDestinations,
        product: .unitTests,
        bundleId: "de.johannesfroelich.WhisperboardKit.CommonTests",
        infoPlist: .default,
